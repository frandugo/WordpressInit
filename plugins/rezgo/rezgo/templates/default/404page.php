<div class="container-fluid">
	...
	<div class="jumbotron">
		...
		<form role="form" class="form-inline" onsubmit="top.location.href='<?php echo $site->base; ?>/keyword/'+$('#rezgo-404-search').val(); return false;">
			<div class="col-lg-6 row">
				<div class="input-group">
					...
					value="<?php echo stripslashes(htmlentities($_REQUEST['search_for'])); ?>" 
					/>
