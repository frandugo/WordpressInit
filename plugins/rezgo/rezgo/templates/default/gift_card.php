		...
		<div class="col-xs-12">
			...
			<?php if (!$site->isVendor() && $site->getGateway()) { ?>
				<div class="rezgo-gift-card-container clearfix">
					<form id="purchase" class="gift-card-purchase" role="form" method="post">
						<div class="rezgo-gift-card-group clearfix">
							<div class="heading">
								<h3><span class="text-info">Buy a Gift Card</span></h3>
								<p>
									<span>Would you like to purchase a gift card? Choose the value you would like to purchase and enter your payment details, it&rsquo;s that simple!</span>
								</p>
							</div>
							...
							<div class="row">
								<div class="col-xs-12">
									<div id="rezgo-credit-card-container">
										...
										<script>jQuery(document).ready(function($){ $('#gift_card_token').val(""); });</script>
								...
								<div class="col-sm-12">
									<div class="form-group">
										...
										<label>
											...
											<a data-toggle="collapse" data-target="#rezgo-terms-panel" class="terms-conditions">Terms &amp; Conditions</a>
										</label>

										<div id="rezgo-terms-panel" class="collapse">
											<div class="collapse-wrapper">
												<?php echo ($site->getPageContent('terms')) ? $site->getPageContent('terms') : 'Gift card terms goes here..' ; ?>
											</div>
										</div>
...
jQuery(document).ready(function($){
			...
			if (card_token == '') {
				...
				$purchaseForm.ajaxSubmit({
					...
					success: function(data){
						...
						if (response == 1) {
							top.location.replace('<?php echo $site->base; ?>/gift-receipt');
						} 
						else {
							if (response == 2) {
	...
	var today = parseInt('<?=strtotime("today");?>');
